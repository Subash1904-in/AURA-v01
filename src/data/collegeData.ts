...
export const collegeDatabase = (
    {
        ...
        departments: {
            ...
            mech: {
                ...
                description: "Welcome to the Department of Mechanical Engineering, where we lay the foundation for tomorrow’s engineers to design, innovate, and optimize the mechanical systems that power the world. The Mechanical Engineering program focuses on the design, analysis, and manufacturing of mechanical systems. Students will gain a strong understanding of core engineering principles, including mechanics, thermodynamics, fluid dynamics, materials science, and control systems. The curriculum integrates theoretical knowledge with practical experience, offering hands-on opportunities in laboratories, workshops, and real-world projects. Vision: To create a platform for fulfilling the changing needs of Mechanical Engineering domain through constant up-gradation and research work. Mission: Promote the professional passion amongst students through exposure to recent advancements. Build partnerships with industries to impart technical exposure and knowledge. Impart ethics by quality teaching and research work through continuous improvements.",
                identifiers: ["mechanical", "mech", "mechanical engineering"],
                faculty: [
                    { name: "Dr. P N Jyothi", designation: "Professor & Head (In-Charge)" },
                    { name: "Dr. Abhishek M R", designation: "Associate Professor" },
                    { name: "Mr. Akash Deep B N", designation: "Assistant Professor" },
                    { name: "Mr. Santosh Kumar K J", designation: "Assistant Professor" },
                    { name: "Dr. Parashuram A Kutakanakeri", designation: "Assistant Professor" },
                    { name: "Mr. Basavaraja K T", designation: "Assistant Professor" },
                    { name: "Mr. Harisha P", designation: "Assistant Professor" },
                    { name: "Mrs. Gayathri Sangappa Pujari", designation: "Assistant Professor" },
                    { name: "Mr. Swaroop Poonaykar B K", designation: "Assistant Professor" },
                    { name: "Mr. B. N. Satish", designation: "Foreman" },
                    { name: "Mr. M. Devarajulu", designation: "Instructor" },
                    { name: "Mr. N. Dhooravasulu", designation: "Welder" },
                    { name: "Mr. Lokesh E", designation: "Technician" },
                    { name: "Mrs. Rekha D", designation: "Office Assistant" },
                    { name: "Smt. Vinayakamma", designation: "Attender" },
                    { name: "Mr. Ravi H K", designation: "Attender" },
                    { name: "Mr. Manjunath V", designation: "Attender" }
                ],
                labs: [
                ...
                placements: {
                    description: "Graduates of this program are prepared to work in a variety of industries, such as automotive, aerospace, manufacturing, energy, robotics, and HVAC. Career paths include roles like mechanical design engineer, thermal systems engineer, manufacturing engineer, robotics engineer, and project manager. With advances in automation, smart manufacturing, and sustainable energy solutions, the demand for skilled mechanical engineers continues to grow across the globe.",
